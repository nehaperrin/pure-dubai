...
with tab4:
    ...
    with tl1: st.markdown('<div class="earthy-green"><b>✓ VERIFIED SAFE</b><br><small>Clean. No active filters detected.</small></div>', unsafe_allow_html=True)
    with tl2: st.markdown('<div class="earthy-yellow"><b>⚠️ CHECK LABEL</b><br><small>Contains a filter (e.g. Salt) but in LOW safe amounts.</small></div>', unsafe_allow_html=True)
    with tl3: st.markdown('<div class="earthy-red"><b>✕ AVOID</b><br><small>Contains active filters or high sugar/salt.</small></div>', unsafe_allow_html=True)
